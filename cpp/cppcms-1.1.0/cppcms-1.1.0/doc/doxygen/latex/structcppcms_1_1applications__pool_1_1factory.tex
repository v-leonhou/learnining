...
\item 
virtual std\+::auto\+\_\+ptr$<$ {\bf application} $>$ {\bf operator()} ({\bf service} \&) const =0
...
\subsubsection[{operator()(service \&) const =0}]{\setlength{\rightskip}{0pt plus 5cm}virtual std\+::auto\+\_\+ptr$<${\bf application}$>$ cppcms\+::applications\+\_\+pool\+::factory\+::operator() (
